...
class ReadLUR:
    ...
    def join_with_ambient_data(self, df):
        ...
        get_col = 'Arithmetic Mean'
        columns = ['fips', 'Year', get_col]
        replace_col_names = {'Year': 'year', get_col:'pred_wght'}
    ...
    def get_df(self):
        ...
        # plt.show()
        """
        Code the two lines below for SA-4
        """
